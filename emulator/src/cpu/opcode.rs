...
lazy_static! {
    static ref OPCODES: HashMap<u8, Opcode> = {
        ...
        add_opcode(m, Opcode::new("DOP", 0x04, 2, 3, AddressingMode::ZeroPage, true));
        add_opcode(m, Opcode::new("DOP", 0x14, 2, 4, AddressingMode::ZeroPageX, true));
        add_opcode(m, Opcode::new("DOP", 0x34, 2, 4, AddressingMode::ZeroPageX, true));
        add_opcode(m, Opcode::new("DOP", 0x44, 2, 3, AddressingMode::ZeroPage, true));
        add_opcode(m, Opcode::new("DOP", 0x54, 2, 4, AddressingMode::ZeroPageX, true));
        add_opcode(m, Opcode::new("DOP", 0x64, 2, 3, AddressingMode::ZeroPage, true));
        add_opcode(m, Opcode::new("DOP", 0x74, 2, 4, AddressingMode::ZeroPageX, true));
        add_opcode(m, Opcode::new("DOP", 0x80, 2, 2, AddressingMode::Immediate, true));
        add_opcode(m, Opcode::new("DOP", 0x82, 2, 2, AddressingMode::Immediate, true));
        add_opcode(m, Opcode::new("DOP", 0x89, 2, 2, AddressingMode::Immediate, true));
        add_opcode(m, Opcode::new("DOP", 0xC2, 2, 2, AddressingMode::Immediate, true));
        add_opcode(m, Opcode::new("DOP", 0xD4, 2, 4, AddressingMode::ZeroPageX, true));
        add_opcode(m, Opcode::new("DOP", 0xE2, 2, 2, AddressingMode::Immediate, true));
        add_opcode(m, Opcode::new("DOP", 0xF4, 2, 4, AddressingMode::ZeroPageX, true));
        ...
        add_opcode(m, Opcode::new("TOP", 0x0C, 3, 4, AddressingMode::Absolute, true));
        add_opcode(m, Opcode::new("TOP", 0x1C, 3, 4, AddressingMode::AbsoluteX, true));
        add_opcode(m, Opcode::new("TOP", 0x3C, 3, 4, AddressingMode::AbsoluteX, true));
        add_opcode(m, Opcode::new("TOP", 0x5C, 3, 4, AddressingMode::AbsoluteX, true));
        add_opcode(m, Opcode::new("TOP", 0x7C, 3, 4, AddressingMode::AbsoluteX, true));
        add_opcode(m, Opcode::new("TOP", 0xDC, 3, 4, AddressingMode::AbsoluteX, true));
        add_opcode(m, Opcode::new("TOP", 0xFC, 3, 4, AddressingMode::AbsoluteX, true));
